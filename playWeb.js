...
(function() {
  var BasicAI, PlayerState, State, action, applyBenefit, arrayEqual, attack, basicCard, c, cloneDominionObject, compileStrategies, countInList, countStr, duration, makeCard, makeStrategy, modifyCoreTypes, noColony, nullUpgradeChoices, numericSort, playGame, prize, restoreCoreTypes, shuffle, spyDecision, stringify, transferCard, transferCardToTop, treasure, upgradeChoices, useCoreTypeMods, _ref,
  ...
  compileStrategies = function(scripts, errorHandler) {
    var i, strategies, strategy, usedNames, _i, _ref, _ref1;
    strategies = [];
    usedNames = [];
    for (i = _i = 0, _ref = scripts.length; 0 <= _ref ? _i < _ref : _i > _ref; i = 0 <= _ref ? ++_i : --_i) {
      try {
        ...
        while (_ref1 = strategy.name, __indexOf.call(usedNames, _ref1) >= 0) {
          strategy.name += "Clone";
        }
  ...
  BasicAI = (function() {
    ...
    BasicAI.prototype.getScoreDifference = function(state, my) {
      var myScore, name, opponentScore, score, status, turns, _i, _len, _ref;
      _ref = state.getFinalStatus();
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        status = _ref[_i];
    ...
    BasicAI.prototype.developValue = function(state, choice, my) {
      var newCard1, newCard2, oldCard, _ref;
      oldCard = choice[0], (_ref = choice[1], newCard1 = _ref[0], newCard2 = _ref[1]);
    ...
    BasicAI.prototype.spendCoinTokens = function(state, my) {
      var cardBought, cardsBought, cardsBoughtOld, coinCost, ct, hypMy, hypState, potionCost, _ref, _ref1;
      cardsBoughtOld = [];
      ct = my.coinTokens;
      while (true) {
        _ref = state.hypothetical(this), hypState = _ref[0], hypMy = _ref[1];
        hypMy.coins += ct;
        ...
        while (hypMy.buys > 0) {
          ...
          if (cardBought != null) {
            _ref1 = cardBought.getCost(hypState), coinCost = _ref1[0], potionCost = _ref1[1];
    ...
    BasicAI.prototype.wantsToPlaySpoils = function(state) {
      var cardsGainedWith, cardsGainedWithout, hypMy, hypState, _ref;
      if (state.depth > 0) {
        return true;
      } else {
  ...
  makeCard('Farmland', c.Estate, {
    ...
    upgradeFilter: function(state, oldCard, newCard) {
      var coins1, coins2, potions1, potions2, _ref, _ref1;
      _ref = oldCard.getCost(state), coins1 = _ref[0], potions1 = _ref[1];
      _ref1 = newCard.getCost(state), coins2 = _ref1[0], potions2 = _ref1[1];
  ...
  makeCard('Ill-Gotten Gains', treasure, {
    ...
    gainEffect: function(state, player) {
      ...
      _results = [];
      for (i = _i = 0, _ref = state.nPlayers; 0 <= _ref ? _i < _ref : _i > _ref; i = 0 <= _ref ? ++_i : --_i) {
  ...
  makeCard('Graverobber', c.Remodel, {
    ...
    playEffect: function(state) {
      var card, choice, choices, coins, newCard, oldCard, potions, _i, _len, _ref, _ref1;
      choices = upgradeChoices(state, state.current.hand, this.upgradeFilter.bind(this));
      _ref = state.trash;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        card = _ref[_i];
        _ref1 = card.getCost(state), coins = _ref1[0], potions = _ref1[1];
  ...
  makeCard('Remake', c.Remodel, {
    ...
    playEffect: function(state) {
      var choice, choices, choices2, i, newCard, oldCard, _i, _results;
      _results = [];
      for (i = _i = 1; _i <= 2; i = ++_i) {
        ...
        if (choice !== null) {
          ...
          state.doTrash(state.current, oldCard);
          if (newCard !== null) {
            _results.push(state.gainCard(state.current, newCard));
          } else {
            _results.push(void 0);
          }
        } else {
  ...
  makeCard('Ambassador', attack, {
    cost: 3,
    playEffect: function(state) {
      var card, cardName, choice, choices, count, counts, i, quantity, _i, _j, _len, _ref, _ref1;
      counts = {};
      _ref = state.current.hand;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        card = _ref[_i];
        if ((_ref1 = counts[card]) == null) {
          counts[card] = 0;
        }
        counts[card] += 1;
      }
  ...
  makeCard('Masterpiece', treasure, {
    ...
    coins: 1,
    buyEffect: function(state) {
      var amountOverpayed, i, _i, _results;
      ...
      _results = [];
      for (i = _i = 1; 1 <= amountOverpayed ? _i <= amountOverpayed : _i >= amountOverpayed; i = 1 <= amountOverpayed ? ++_i : --_i) {
        _results.push(state.gainCard(state.current, c['Silver'], 'discard', true));
      }
      return _results;
    }
  });
  ...
  makeCard('Rogue', attack, {
    ...
    coins: +2,
    playEffect: function(state) {
      var card, cardToGain, coins, gainables, my, potions, _i, _len, _ref, _ref1;
      my = state.current;
      gainables = [];
      _ref = state.trash;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      ...
      if (gainables.length > 0) {
        ...
        return state.attackOpponents(function(opp) {
          var cardToTrash, drawn, drawnTrashables, _j, _len1, _ref2;
          drawn = opp.getCardsFromDeck(2);
          state.log("..." + opp.ai + " reveals " + drawn + ".");
          drawnTrashables = [];
          for (_j = 0, _len1 = drawn.length; _j < _len1; _j++) {
            card = drawn[_j];
  ...
  makeCard('Alchemist', action, {
    ...
    cleanupEffect: function(state) {
      var _ref, _ref1;
      if ((_ref = c.Potion, __indexOf.call(state.current.inPlay, _ref) >= 0) && (_ref1 = c.Alchemist, __indexOf.call(state.current.inPlay, _ref1) >= 0)) {
  ...
  makeCard('Baker', action, {
    ...
    startGameEffect: function(state) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        player = _ref[_i];
        _results.push(player.coinTokens += 1);
      }
      return _results;
    },
    ai_playValue: function(state, my) {
  ...
  makeCard('Bishop', action, {
    ...
    coins: +1,
    playEffect: function(state) {
      var coins, opp, potions, toTrash, vp, _i, _len, _ref, _ref1, _results;
  ...
  makeCard('Border Village', c.Village, {
    cost: 6,
    gainEffect: function(state, player) {
      var card, choices, coins, myCoins, myPotions, potions, _ref, _ref1;
      choices = [];
      _ref = c['Border Village'].getCost(state), myCoins = _ref[0], myPotions = _ref[1];
      for (card in state.supply) {
        if (state.supply[card] > 0) {
          _ref1 = c[card].getCost(state), coins = _ref1[0], potions = _ref1[1];
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        if (drawn != null) {
          ...
          if (discarded != null) {
            ...
            _results.push(pl.discard.push(drawn));
          } else {
            state.log("...choosing to put it back.");
            _results.push(pl.draw.unshift(drawn));
          }
        } else {
          _results.push(void 0);
        }
  ...
  makeCard('Embassy', action, {
    ...
    gainEffect: function(state, player) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        pl = _ref[_i];
        if (pl !== player) {
          _results.push(state.gainCard(pl, c.Silver));
        } else {
          _results.push(void 0);
        }
      }
      ...
      if (drawn.length > 0) {
        ...
        for (_i = 0, _len = actions.length; _i < _len; _i++) {
          ...
          if (card != null) {
            ...
            _results.push(state.resolveAction(card));
          } else {
            _results.push(void 0);
          }
        }
  ...
  makeCard('Haggler', action, {
    ...
    buyInPlayEffect: function(state, card1) {
      var card2, cardName, choices, coins1, coins2, potions1, potions2, _ref, _ref1;
      _ref = card1.getCost(state), coins1 = _ref[0], potions1 = _ref[1];
      choices = [];
      for (cardName in state.supply) {
        card2 = c[cardName];
        _ref1 = card2.getCost(state), coins2 = _ref1[0], potions2 = _ref1[1];
  ...
  makeCard('Ironworks', action, {
    cost: 4,
    playEffect: function(state) {
      var card, cardName, choices, coins, count, gained, potions, _ref, _ref1;
      choices = [];
      _ref = state.supply;
  ...
  makeCard('Journeyman', action, {
    cost: 5,
    playEffect: function(state) {
      var card, choice, choices, deck, drawn, my, newcards, unique, _i, _len;
      unique = [];
  ...
  makeCard("King's Court", action, {
    ...
    optional: true,
    playEffect: function(state) {
      var card, choices, chosenAction, i, md, neverPutInDuration, putInDuration, _i, _j, _ref, _ref1;
      choices = (function() {
        var _i, _len, _ref, _results;
        _ref = state.current.hand;
        _results = [];
      ...
      if (choices.length === 0) {
        ...
        if (chosenAction === null) {
          ...
          for (i = _i = 0, _ref = this.multiplier; 0 <= _ref ? _i < _ref : _i > _ref; i = 0 <= _ref ? ++_i : --_i) {
            if (chosenAction === null) {
              return;
            }
          ...
          if (!neverPutInDuration) {
            ...
            if (chosenAction.isDuration && chosenAction.name !== 'Tactician') {
              putInDuration = true;
              for (i = _j = 0, _ref1 = this.multiplier - 1; 0 <= _ref1 ? _j < _ref1 : _j > _ref1; i = 0 <= _ref1 ? ++_j : --_j) {
  ...
  makeCard("Mandarin", action, {
    ...
    gainEffect: function(state, player) {
      var card, order, treasures, _i, _len;
      treasures = (function() {
        var _i, _len, _ref, _results;
        _ref = player.inPlay;
        _results = [];
  ...
  makeCard("Masquerade", action, {
    ...
    cards: +2,
    playEffect: function(state) {
      var cardToPass, i, nextPlayer, passed, player, _i, _j, _len, _ref, _ref1;
      passed = [];
      _ref = state.players;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        player = _ref[_i];
      ...
      for (i = _j = 0, _ref1 = state.nPlayers; 0 <= _ref1 ? _j < _ref1 : _j > _ref1; i = 0 <= _ref1 ? ++_j : --_j) {
  ...
  makeCard("Mint", action, {
    cost: 5,
    buyEffect: function(state) {
      var i, inPlay, m, _i, _ref, _results;
      ...
      _results = [];
      for (i = _i = _ref = inPlay.length - 1; _ref <= -1 ? _i < -1 : _i > -1; i = _ref <= -1 ? ++_i : --_i) {
        if (inPlay[i].isTreasure) {
          state.log("...trashing a " + inPlay[i] + ".");
          state.trash.push(inPlay[i]);
          _results.push(inPlay.splice(i, 1));
        } else {
          _results.push(void 0);
        }
      }
  ...
  makeCard('Plaza', c.Village, {
    ...
    playEffect: function(state) {
      ...
      if (choice != null) {
        if (__indexOf.call(possibleDiscards, choice) >= 0) {
  ...
  makeCard('Rats', action, {
    ...
    cards: +1,
    playEffect: function(state) {
      var card, my, toTrash, trashables, _i, _len, _ref;
      my = state.current;
      trashables = [];
      _ref = my.hand;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
  ...
  makeCard('Rebuild', action, {
    ...
    actions: +1,
    playEffect: function(state) {
      var card, cardToTrash, cardname, choices, coins1, coins2, drawn, my, namedcard, newCard, potions1, potions2, vpChoices, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2, _ref3, _ref4;
      my = state.current;
      choices = [];
      _ref = ["Estate", "Duchy", "Duke", "Province", "Colony"];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        cardname = _ref[_i];
        card = c[cardname];
      ...
      for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
        card = _ref1[_j];
        if (__indexOf.call(choices, card) < 0 && card.isVictory) {
          choices.push(card);
        }
      }
      ...
      if (drawn !== null && drawn.length > 0) {
        ...
        state.trash.push(drawn[0]);
        vpChoices = [];
        _ref2 = ["Estate", "Duchy", "Duke", "Province", "Colony"];
        for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
          cardname = _ref2[_k];
          card = c[cardname];
          if (state.supply[card] > 0) {
            _ref3 = cardToTrash.getCost(state), coins1 = _ref3[0], potions1 = _ref3[1];
            _ref4 = card.getCost(state), coins2 = _ref4[0], potions2 = _ref4[1];
            if (coins2 <= coins1 + 3) {
              vpChoices.push(card);
            }
          }
  ...
  makeCard('Tournament', action, {
    ...
    actions: +1,
    startGameEffect: function(state) {
      var name, prizeNames, prizes, _i, _len;
    ...
    playEffect: function(state) {
      var choice, choices, discardProvince, opp, opposingProvince, prizes, _i, _len, _ref, _ref1, _ref2;
      opposingProvince = false;
      _ref = state.players.slice(1);
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        opp = _ref[_i];
        if (_ref1 = c.Province, __indexOf.call(opp.hand, _ref1) >= 0) {
          state.log("" + opp.ai + " reveals a Province.");
          opposingProvince = true;
        }
      }
      if (_ref2 = c.Province, __indexOf.call(state.current.hand, _ref2) >= 0) {
        ...
        if (discardProvince) {
          ...
          choices = (function() {
            ...
            _results = [];
            for (_j = 0, _len1 = prizes.length; _j < _len1; _j++) {
              prize = prizes[_j];
  ...
  makeCard('Treasure Map', action, {
    cost: 4,
    playEffect: function(state) {
      var num, numGolds, trashedMaps, _i, _ref, _ref1;
      trashedMaps = 0;
      ...
      if (_ref1 = c['Treasure Map'], __indexOf.call(state.current.hand, _ref1) >= 0) {
  ...
  makeCard('Tribute', action, {
    cost: 5,
    playEffect: function(state) {
      var card, revealedCards, unique, _i, _j, _len, _len1, _results;
      ...
      for (_j = 0, _len1 = unique.length; _j < _len1; _j++) {
        ...
        if (card.isVictory) {
          _results.push(state.current.drawCards(2));
        } else {
          _results.push(void 0);
        }
      }
  ...
  PlayerState = (function() {
    ...
    PlayerState.prototype.getDeck = function() {
      var contents, name, result, _ref1, _ref2;
      ...
      for (name in _ref1) {
        ...
        contents = _ref1[name];
        if (contents != null) {
          if (contents.hasOwnProperty('playEffect') || ((_ref2 = contents[0]) != null ? _ref2.hasOwnProperty('playEffect') : void 0)) {
    ...
    PlayerState.prototype.countCardTypeInDeck = function(type) {
      var card, count, typeChecker, _i, _len, _ref1;
      typeChecker = 'is' + type;
      count = 0;
      _ref1 = this.getDeck();
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
    ...
    PlayerState.prototype.menagerieDraws = function() {
      var card, cardsToDraw, seen, _i, _len, _ref1;
      seen = {};
      cardsToDraw = 3;
      _ref1 = this.hand;
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
    ...
    PlayerState.prototype.shantyTownDraws = function(hypothetical) {
      var card, cardsToDraw, skippedShanty, _i, _len, _ref1;
    ...
    PlayerState.prototype.actionBalance = function() {
      var balance, card, _i, _len, _ref1;
  ...
  State = (function() {
    ...
    State.prototype.initialize = function(ais, tableau, logFunc) {
      var ai, card, player, playerNum, _i, _j, _len, _len1;
      this.logFunc = logFunc;
      ...
      for (_j = 0, _len1 = tableau.length; _j < _len1; _j++) {
        card = tableau[_j];
    ...
    State.prototype.setUpWithOptions = function(ais, options) {
      var ai, card, index, moreCards, tableau, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref1, _ref2, _ref3, _ref4;
      tableau = [];
      if (options.require != null) {
        _ref1 = options.require;
        for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
          card = _ref1[_i];
          tableau.push(c[card]);
        }
      }
      for (_j = 0, _len1 = ais.length; _j < _len1; _j++) {
        ai = ais[_j];
        if (ai.requires != null) {
          _ref2 = ai.requires;
          for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
      ...
      for (_l = 0, _len3 = tableau.length; _l < _len3; _l++) {
        card = tableau[_l];
    ...
    State.prototype.gameIsOver = function() {
      ...
      if (emptyPiles.length >= this.totalPilesToEndGame() || (this.nPlayers < 5 && emptyPiles.length >= 3) || __indexOf.call(emptyPiles, 'Province') >= 0 || __indexOf.call(emptyPiles, 'Colony') >= 0 || (__indexOf.call(emptyPiles, 'Curse') >= 0 && __indexOf.call(emptyPiles, 'Copper') >= 0 && this.current.turnsTaken >= 100)) {
        ...
        for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
          _ref2 = _ref1[_i], playerName = _ref2[0], vp = _ref2[1], turns = _ref2[2];
    ...
    State.prototype.getFinalStatus = function() {
      var player, _i, _len, _ref1, _results;
      _ref1 = this.players;
      _results = [];
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        player = _ref1[_i];
    ...
    State.prototype.getWinners = function() {
      var best, bestScore, modScore, player, score, scores, turns, _i, _len, _ref1;
      scores = this.getFinalStatus();
      best = [];
      bestScore = -Infinity;
      for (_i = 0, _len = scores.length; _i < _len; _i++) {
        _ref1 = scores[_i], player = _ref1[0], score = _ref1[1], turns = _ref1[2];
    ...
    State.prototype.countInSupply = function(card) {
      var _ref1;
      return (_ref1 = this.supply[card]) != null ? _ref1 : 0;
    };
    ...
    State.prototype.gainsToEndGame = function() {
      var card, count, counts, minimum, piles, _i, _len, _ref1;
    ...
    State.prototype.smugglerChoices = function() {
      var card, choices, coins, potions, prevPlayer, _i, _len, _ref1, _ref2;
      choices = [null];
      prevPlayer = this.players[this.nPlayers - 1];
      _ref1 = prevPlayer.gainedThisTurn;
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        card = _ref1[_i];
        _ref2 = card.getCost(this), coins = _ref2[0], potions = _ref2[1];
    ...
    State.prototype.countTotalCards = function() {
      var card, count, player, total, _i, _len, _ref1, _ref2, _ref3;
      total = 0;
      _ref1 = this.players;
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        player = _ref1[_i];
    ...
    State.prototype.buyCausesToLose = function(player, state, card) {
      var cardInPlay, coinCost, goonses, hypMy, hypState, i, maxOpponentScore, myScore, name, potionCost, score, status, turns, _i, _j, _len, _ref1, _ref2, _ref3, _ref4, _ref5;
      ...
      card.onBuy(hypState);
      for (i = _j = _ref4 = hypMy.inPlay.length - 1; _ref4 <= -1 ? _j < -1 : _j > -1; i = _ref4 <= -1 ? ++_j : --_j) {
    ...
    State.prototype.doDurationPhase = function() {
      var card, i, _i, _j, _len, _ref1, _ref2;
      this.current.gainedThisTurn = [];
      for (i = _i = _ref1 = this.current.duration.length - 1; _ref1 <= -1 ? _i < -1 : _i > -1; i = _ref1 <= -1 ? ++_i : --_i) {
        card = this.current.duration[i];
        this.log("" + this.current.ai + " resolves the duration effect of " + card + ".");
        card.onDuration(this);
      }
      _ref2 = this.current.multipliedDurations;
    ...
    State.prototype.doActionPhase = function() {
      var card, validActions, _i, _len, _ref1;
      while (this.current.actions > 0) {
        validActions = [null];
        _ref1 = this.current.hand;
        for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
          card = _ref1[_i];
    ...
    State.prototype.doTreasurePhase = function() {
      var card, ctd, validTreasures, _i, _len, _ref1, _results;
      while (true) {
        validTreasures = [null];
        _ref1 = this.current.hand;
        for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
      ...
      while ((ctd = this.getCoinTokenDecision()) > 0) {
        ...
        _results.push(this.current.coinTokens -= ctd);
      }
      return _results;
    };
    ...
    State.prototype.getSingleBuyDecision = function() {
      var buyable, card, cardname, checkSuicide, choice, coinCost, count, potionCost, _ref1, _ref2;
      buyable = [null];
      checkSuicide = this.depth === 0 && this.gainsToEndGame() <= 2;
      _ref1 = this.supply;
      for (cardname in _ref1) {
        count = _ref1[cardname];
        card = c[cardname];
    ...
    State.prototype.doBuyPhase = function() {
      var cardInPlay, choice, coinCost, i, potionCost, _i, _ref1, _ref2;
      while (this.current.buys > 0) {
        ...
        _ref1 = choice.getCost(this), coinCost = _ref1[0], potionCost = _ref1[1];
        this.current.coins -= coinCost;
        this.current.potions -= potionCost;
        this.current.buys -= 1;
        this.gainCard(this.current, choice, 'discard', true);
        choice.onBuy(this);
        for (i = _i = _ref2 = this.current.inPlay.length - 1; _ref2 <= -1 ? _i < -1 : _i > -1; i = _ref2 <= -1 ? ++_i : --_i) {
    ...
    State.prototype.doCleanupPhase = function() {
      var actionCardsInPlay, card, cardsToCleanup, i, _i, _j, _k, _len, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
      actionCardsInPlay = 0;
      _ref1 = this.current.inPlay;
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        card = _ref1[_i];
        if (card.isAction) {
          actionCardsInPlay += 1;
      ...
      if (actionCardsInPlay <= 2) {
        while (_ref2 = c['Walled Village'], __indexOf.call(this.current.inPlay, _ref2) >= 0) {
      ...
      this.extraturn = !this.extraturn && (_ref3 = c['Outpost'], __indexOf.call(this.current.inPlay, _ref3) >= 0);
      ...
      for (i = _j = _ref4 = this.current.multipliedDurations.length - 1; _ref4 <= -1 ? _j < -1 : _j > -1; i = _ref4 <= -1 ? ++_j : --_j) {
      ...
      for (i = _k = _ref5 = cardsToCleanup.length - 1; _ref5 <= -1 ? _k < -1 : _k > -1; i = _ref5 <= -1 ? ++_k : --_k) {
    ...
    State.prototype.gainCard = function(player, card, gainLocation, suppressMessage) {
      var gainSource, i, location, reactCard, _i, _ref1;
      ...
      if (this.supply[card] > 0 || this.specialSupply[card] > 0) {
        for (i = _i = _ref1 = player.hand.length - 1; _ref1 <= -1 ? _i < -1 : _i > -1; i = _ref1 <= -1 ? ++_i : --_i) {
    ...
    State.prototype.handleGainCard = function(player, card, gainLocation, gainSource) {
      var cardInPlay, i, opp, quantity, reactCard, supplyCard, _i, _j, _k, _l, _len, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
      if (gainLocation == null) {
        gainLocation = 'discard';
      }
      if (gainSource == null) {
      ...
      _ref1 = this.supply;
      for (supplyCard in _ref1) {
        if (!__hasProp.call(_ref1, supplyCard)) continue;
        quantity = _ref1[supplyCard];
        c[supplyCard].globalGainEffect(this, player, card, gainSource);
      }
      _ref2 = this.specialSupply;
      for (supplyCard in _ref2) {
        if (!__hasProp.call(_ref2, supplyCard)) continue;
        quantity = _ref2[supplyCard];
        c[supplyCard].globalGainEffect(this, player, card, gainSource);
      }
      for (i = _i = _ref3 = player.inPlay.length - 1; _ref3 <= -1 ? _i < -1 : _i > -1; i = _ref3 <= -1 ? ++_i : --_i) {
        cardInPlay = player.inPlay[i];
        cardInPlay.gainInPlayEffect(this, card);
      }
      for (i = _j = _ref4 = player.hand.length - 1; _ref4 <= -1 ? _j < -1 : _j > -1; i = _ref4 <= -1 ? ++_j : --_j) {
        reactCard = player.hand[i];
        if (reactCard.isReaction) {
          reactCard.reactToGain(this, player, card);
        }
      }
      _ref5 = this.players.slice(1);
      for (_k = 0, _len = _ref5.length; _k < _len; _k++) {
        opp = _ref5[_k];
        for (i = _l = _ref6 = opp.hand.length - 1; _ref6 <= -1 ? _l < -1 : _l > -1; i = _ref6 <= -1 ? ++_l : --_l) {
    ...
    State.prototype.handleDiscards = function(player, cards) {
      ...
      for (_i = 0, _len = cards.length; _i < _len; _i++) {
        card = cards[_i];
        if (card.isReaction) {
          _results.push(card.reactToDiscard(this, player));
        } else {
          _results.push(void 0);
        }
      }
    ...
    State.prototype.attackOpponents = function(effect) {
      var opp, _i, _len, _ref1, _results;
      _ref1 = this.players.slice(1);
      _results = [];
      for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
        opp = _ref1[_i];
    ...
    State.prototype.attackPlayer = function(player, effect) {
      var attackEvent, card, reactionCards, _i, _j, _len, _len1, _ref1;
      attackEvent = {};
    ...
    State.prototype.copy = function() {
      var card, copy, k, key, newCardState, newPlayers, newSpecialSupply, newState, newSupply, player, playerCopy, state, v, value, _i, _len, _ref1, _ref2, _ref3, _ref4;
      newSupply = {};
      _ref1 = this.supply;
      for (key in _ref1) {
        value = _ref1[key];
    ...
    State.prototype.hypothetical = function(ai) {
      var combined, counter, handSize, my, player, state, _i, _len, _ref1;
      state = this.copy();
      counter = 0;
  ...
  modifyCoreTypes = function() {
    var _base;
    (_base = Array.prototype)._originalToString || (_base._originalToString = Array.prototype.toString);
